...
def draw_circles2():
    ...
    for w in range (50,410,20):
        center = rg.Point(w, 100)
...
def draw_cosines_and_sines():
    ...
    for w in range(0, 101, 1):
        center = rg.Point((200+(80 * math.cos(w))), (200+(80 * math.sin(w))))
        circle = rg.Circle(center, 10)
        circle.attach_to(window)
        window.render(0.05)
